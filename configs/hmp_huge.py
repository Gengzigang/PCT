...
optimizer = dict(type='AdamW', lr=2.5e-4, betas=(0.9, 0.999), weight_decay=0.1,
                 constructor='SwinLayerDecayOptimizerConstructor',
                 paramwise_cfg=dict(num_layers=[2, 2, 42, 2], layer_decay_rate=0.95,
...
model = dict(
    type='TopDown',
    pretrained='weights/simmim/swin_huge.pth',
    backbone=dict(
